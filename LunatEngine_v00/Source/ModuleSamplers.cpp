...
bool ModuleSamplers::init()
{
    ...
    device->CreateDescriptorHeap(&heapDesc, IID_PPV_ARGS(&sanplerHeap));

    sanplerHeap->SetName(L"Module Samplers Heap");

    cpuStart = sanplerHeap->GetCPUDescriptorHandleForHeapStart();
    gpuStart = sanplerHeap->GetGPUDescriptorHandleForHeapStart();
